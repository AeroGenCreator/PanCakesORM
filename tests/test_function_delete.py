...
insert(
    ...
    params=[
        {
            "table": "category",
            "data": [(None, "Lacteos"), (None, "Harinas"), (None, "Extras")],
        },
        {
            "table": "product",
            "data": [
        ...
        params=[
            {
                "table": "product",
                "condition": [
                    {"column": "product_id", "operator": "=", "value": 4}
                ],
            },
            {
                "table": "client",
                "condition": [
                    {"column": "client_id", "operator": ">=", "value": 1}
                ],
            },
        ],
    )
        ...
        params=[
            {
                ...
                "condition": [
                    ...
                    {"column": "product_id", "operator": ">", "value": 3},
                ],
            }
        ],
    )
...
def test_new_relational_data():
    insert(
        db_path=file_path,
        params=[
            {"table": "client", "data": [(None, "Andres", "Lopez")]},
            {"table": "product", "data": [(None, "Leche", 25, None)]},
            {"table": "sale_line", "data": [(None, 1, 1)]},
        ],
    )
...
def test_delete_relationals_by_force():
    insert(
        db_path=file_path,
        params=[
            {"table": "product", "data": [(None, "Chocolate", 30, None)]},
            {"table": "sale_line", "data": [(None, 1, 1)]},
        ],
    )
