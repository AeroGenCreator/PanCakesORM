...
def test_dependenncies():
    ...
    assert Product.table_exists() is True
    assert Category.table_exists() is True
    assert SaleLine.table_exists() is True
    assert Client.table_exists() is True
    assert Sale.table_exists() is True
...
def test_quitar_group_constraint():
    ...
    assert api == [
        {
            "sale_line__sale_line_id": 1,
            "sale_line__product_id": 1,
            "sale_line__category_id": 1,
            "sale_line__client_id": None,
            "sale_line__sale_id": None,
            "sale_line__quantity": None,
        },
        {
            "sale_line__sale_line_id": 2,
            "sale_line__product_id": 1,
            "sale_line__category_id": 1,
            "sale_line__client_id": None,
            "sale_line__sale_id": None,
